...
@Component({
  selector: 'app-tabla-desinstalacion',
  templateUrl: './tabla-desinstalacion.component.html',
  styleUrls: ['./tabla-desinstalacion.component.scss']
})
export class TablaDesinstalacionComponent implements OnInit {

  displayedColumns: string[] = ['number', 'rif', 'razon_social', 'fecha', 'acciones'];
  solicitudes = [];
  ...
  @Output() changePos = new EventEmitter<any>();
      ...
      .pipe(
        ...
        switchMap(() => {
          ...
          const data = this.crypto.encryptString(JSON.stringify({
            ...
            t_sol_id: this.crypto.encryptJson("8"),
          }))
