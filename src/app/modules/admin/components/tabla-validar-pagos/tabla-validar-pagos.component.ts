...
import { ShowSalesResponse, ShowSalesDecrypter } from 'src/app/models/showsales_response';
...
@Component({
  selector: 'app-tabla-validar-pagos',
  templateUrl: './tabla-validar-pagos.component.html',
  styleUrls: ['./tabla-validar-pagos.component.scss']
})
export class TablaValidarPagosComponent implements OnInit {
      ...
      .pipe(
        ...
        switchMap(() => {
          ...
          const data = this.crypto.encryptString(JSON.stringify({
            ...
            status_desc: this.crypto.encryptJson("VALIDAR PAGO"),
          }))
