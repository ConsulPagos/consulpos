...
@Component({
  selector: 'app-tabla-plataformas',
  templateUrl: './tabla-plataformas.component.html',
  styleUrls: ['./tabla-plataformas.component.scss']
})
export class TablaPlataformasComponent implements OnInit {

  displayedColumns: string[] = ['plataforma','estatus', 'acciones'];
  plataforma = [];
    ...
    merge(this.paginator.page)
      .pipe(
        ...
        map(data => {
          ...
          this.showPlataformasResponse = new ShowPlataformasDecrypter(this.crypto).deserialize(JSON.parse(this.crypto.decryptString(data)))
          ...
          this.resultsLength = parseInt(this.showPlataformasResponse.total_row);
          // console.log(this.showPlataformasResponse)
          return this.showPlataformasResponse.plataformas;
        }),
        catchError((e) => {
          this.firstLoading = false;
          this.loading = false;
