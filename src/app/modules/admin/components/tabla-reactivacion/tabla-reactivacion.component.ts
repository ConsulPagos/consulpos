...
@Component({
  selector: 'app-tabla-reactivacion',
  templateUrl: './tabla-reactivacion.component.html',
  styleUrls: ['./tabla-reactivacion.component.scss']
})
export class TablaReactivacionComponent implements OnInit {
      ...
      .pipe(
        ...
        switchMap(() => {
          ...
          const data = this.crypto.encryptString(JSON.stringify({
            ...
            t_sol_id: this.crypto.encryptJson("9"),
          }))
