...
@Component({
  selector: 'app-tabla-cambio-equipo',
  templateUrl: './tabla-cambio-equipo.component.html',
  styleUrls: ['./tabla-cambio-equipo.component.scss']
})
export class TablaCambioEquipoComponent implements OnInit {
      ...
      .pipe(
        ...
        switchMap(() => {
          ...
          const data = this.crypto.encryptString(JSON.stringify({
            ...
            t_sol_id: this.crypto.encryptJson("5"),
          }))
