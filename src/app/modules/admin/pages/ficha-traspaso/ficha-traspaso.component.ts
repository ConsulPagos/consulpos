...
@Component({
  selector: 'app-ficha-traspaso',
  templateUrl: './ficha-traspaso.component.html',
  styleUrls: ['./ficha-traspaso.component.scss'],
  animations: [
...
export class FichaTraspasoComponent implements OnInit {
