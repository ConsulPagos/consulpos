...
@Component({
  ...
  templateUrl: './add-reactivacion.component.html',
  styleUrls: ['./add-reactivacion.component.scss']
})
export class AddReactivacionComponent implements OnInit {
 ...
 submit() {
   ...
   this.venta.crearReactivacionDeEquipo(`${this.session.getDeviceId()};${data}`).subscribe(res => {
