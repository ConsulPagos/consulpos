...
@Component({
  selector: 'app-prueba-correctivo',
  templateUrl: './prueba-correctivo.component.html',
  styleUrls: ['./prueba-correctivo.component.scss']
})
export class PruebaCorrectivoComponent implements OnInit {
