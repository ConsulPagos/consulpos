...
@Component({
  selector: 'app-add-cambio-banco',
  templateUrl: './add-cambio-banco.component.html',
  styleUrls: ['./add-cambio-banco.component.scss']
})
export class AddCambioBancoComponent implements OnInit {
  ...
  submit() {
    ...
    this.venta.doCambioDeBanco(`${this.session.getDeviceId()};${data}`).subscribe(res => {
