...
@Component({
  selector: 'app-cargar-inventario-sim',
  templateUrl: './cargar-inventario-sim.component.html',
  styleUrls: ['./cargar-inventario-sim.component.scss']
})
export class CargarInventarioSimComponent implements OnInit {
