...
@Component({
  selector: 'app-portafolio-carrusel',
  templateUrl: './portafolio-carrusel.component.html',
  styleUrls: ['./portafolio-carrusel.component.scss']
})
export class PortafolioCarruselComponent implements OnInit {
